...
<div class="container">
    ...
    <form @submit.prevent="editarNota(notaEditar)" v-if="editar">
        ...
        <input type="text" class="form-control my-2" placeholder="Apellido" v-model="notaEditar.apellido">
    ...
    <form @submit.prevent="agregarNota()" v-if="!editar">
        ...
        <input type="text" class="form-control my-2" placeholder="Apellido" v-model="nota.apellido"> 
        <input type="text" class="form-control my-2" placeholder="Direccion" v-model="nota.direccion">
...
export default {
    ...
    data() {
        return {
            ...
            nota:{codigo:"", nombre:"", apellido:"", direccion:""}, //Este objeto es el que yo voy a enviar al servidor (mediante POST) cuando se crea una nota en el formualrio -> Aca deben ir los campos del producto 
            editar:false,
            notaEditar:{}
    ...
    methods: { //Funciones que yo voy a utilizar 
        ...
        listarNotas() {
            ...
            this.axios.get('/employee')   //Axios es un cliente HTTP que me permite generar peticiones (get,put,post,etc)
        ...
        agregarNota(){
            ...
            this.axios.post('/newemployee',this.nota)
            .then(res=>{
        ...
        editarNota(item){
            ...
            this.axios.put(`/editemployee/${item._id}`, item)
            .then(res=>{
